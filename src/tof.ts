const u_tof = (() => {
     ...
     * @returns {boolean}
     */
    const falsyExcept = (value: any, condition: Function): boolean => falsy(value) && !condition(value);
    ...
    * @returns {boolean}
    */
    const truthyExcept = (value: any, condition: Function): boolean => !falsyExcept(value, condition);
     ...
     * @returns {boolean}
     */
    const falsyExceptEmptyStr = (value: any): boolean => falsyExcept(value, (value: any) => value === "");
     ...
     * @returns {boolean}
     */
    const truthyExceptEmptyStr = (value: any): boolean => !falsyExceptEmptyStr(value);
     ...
     * @returns {boolean}
     */
    const falsyExceptZero = (value: any): boolean => falsyExcept(value, (value: any) => value === 0);
